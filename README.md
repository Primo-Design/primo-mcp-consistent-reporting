...
Replace existing company logo with your own - `company-logo.png`.
Replace `screenshot.png` which an image depicting your personal wanted design.
...
## Create another reporting using the same content / design

Create a new report using the existing style.css for the period June 17 to June 30 2026. It shall use the same structure as the other overivew report html files.

## Convert it to PowerPoint
Take all overview html files you find in html-reports and convert it to a single Powerpoint file.
